...
- [#363](https://github.com/proxlane/proxlane/pull/363) [`0553d62`](https://github.com/proxlane/proxlane/commit/0553d621a836e48b498558fde00a69ab08b10622) Thanks [@scarsam](https://github.com/scarsam)! - The recorder now redacts each component of a composite provider key, not only the whole string. Bright Data's key is a zone and a token joined by a colon, and the adapter sends the zone as its own field, so the zone was reaching fixtures in cleartext.
