	...
	return (
		<DocPage title={TITLE} summary={SUMMARY}>
			<div className="doc-prose max-w-[46rem]">
				<p>
					Proxlane routes scraping requests across ScraperAPI, ScrapingBee, Scrapfly, Bright
					Data and Firecrawl. When a provider blocks, errors or times out, the next one is
					tried. The response says exactly what happened.
				</p>
				<p>
