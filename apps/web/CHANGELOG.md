...
- Updated dependencies [[`0553d62`](https://github.com/proxlane/proxlane/commit/0553d621a836e48b498558fde00a69ab08b10622)]:
  - @proxlane/adapters@0.12.1
...
- [#327](https://github.com/proxlane/proxlane/pull/327) [`ccecd47`](https://github.com/proxlane/proxlane/commit/ccecd47fa88aaabe18fe1a92aa6b6b10f709b671) Thanks [@scarsam](https://github.com/scarsam)! - The providers and API docs pages read plainer: no em dashes, less filler, same facts.
...
- [#294](https://github.com/proxlane/proxlane/pull/294) [`c66450d`](https://github.com/proxlane/proxlane/commit/c66450ddc47483a9629d54fe654ef977f5f01cda) Thanks [@scarsam](https://github.com/scarsam)! - A migration page family at `/migrate`, with its first page: migrate from ScraperAPI. The one-line hostname change, the parameter map read from the adapter's own translation step (including the seven ScraperAPI parameters the gateway ignores today, and how `X-Ignored-Params` names them), the credit multipliers as documented on 2026-08-31, and what changes for the better. `content:lint` now covers every page family under `content/`, not only symptoms, and `docs:check` resolves internal links against every route on disk rather than `/docs/*` alone.

## 0.9.12

### Patch Changes

- Updated dependencies [[`e1971f5`](https://github.com/proxlane/proxlane/commit/e1971f5394dbdd9d91a86c58d8eebf7585ef8e0c), [`08a3079`](https://github.com/proxlane/proxlane/commit/08a30793adf9dfcc69f110594ce68cfc0d09c033)]:
  - @proxlane/shared@0.12.0
  - @proxlane/adapters@0.10.2

## 0.9.11

### Patch Changes

- Updated dependencies [[`d0e5acc`](https://github.com/proxlane/proxlane/commit/d0e5acc39663142823748136da43a7388cd92c00)]:
  - @proxlane/adapters@0.10.1

## 0.9.10

### Patch Changes

- Updated dependencies [[`b9f7c89`](https://github.com/proxlane/proxlane/commit/b9f7c895172ab202947a10a0a4cfccad634b84e5), [`6786892`](https://github.com/proxlane/proxlane/commit/6786892dcdbe219911693fc452ad5b7c9c1a491b)]:
  - @proxlane/adapters@0.10.0
